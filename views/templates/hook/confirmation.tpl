...
<p>
	...
	<br />- {l s='Reference' mod='apirone'} : <span class="reference"><strong>{$reference|escape:'htmlall':'UTF-8'}</strong></span>
	<br /><br />{l s='An email has been sent with this information.' mod='apirone'}
	<br /><br />{l s='If you have questions, comments or concerns, please contact our' mod='apirone'} <a href="{$link->getPageLink('contact', true)|escape}">{l s='expert customer support team.' mod='apirone'}</a>
</p>
{else}
